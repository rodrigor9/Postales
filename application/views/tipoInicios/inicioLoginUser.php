...
<main class="page landing-page">
    <section class="clean-block clean-hero" style="background-image:url(&quot;assets/img/tech/image4.jpg&quot;);color:rgba(236, 255, 216,.6);">
        <div class="text">
            ...
            <p>Mandar postales a tus conocidos, nunca fue tan fácil. Únete al equipo de iPostal y comienza a crear tus propias postales.</p><a class="btn btn-outline-success" href="<?php base_url(); ?>postales">Ver Postales</a></div>
    </section>
